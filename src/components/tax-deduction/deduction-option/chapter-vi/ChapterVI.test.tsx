...
>;
describe("test ChapterVI component", () => {
  ...
  const setup = (isEditable = false, editableEntryId = "") => {
    ...
    mockUseSelector.mockReturnValue({
      options: [
        {
          id: "1",
          category: "selfDisability",
          amount: 1000,
        },
        { category: "educationLoanInterest", amount: 2000 },
      ],
      deductedAmount: 0,
      isEditable,
      editableEntryId,
  ...
  test("render the ChapterVI component with default content", () => {
    setup();
    expect(screen.getByText(/Self Disability - 80U/i)).toBeInTheDocument();
